            ...
            <form method="POST" action="">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="customer" required name="name"
                            aria-describedby="emailHelp">
                    </div>
                    <div class="mb-3">
                        <label for="phone" class="form-label">NO. HP</label>
                        <input type="text" class="form-control" id="phone" onkeyup="digits(this)" required name="phone"
                            aria-describedby="emailHelp">
                    </div>
                    <div class="mb-3">
...
<script>
    ...
    async function editData(id) {
        const response = await fetch(`{{url('/customer/edit/${id}')}}`);
